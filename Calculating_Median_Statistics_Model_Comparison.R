...
observation=read.csv("actual_wet.csv")
...
plot(median.r2, main = "Median R2 Values", ylab="Median R2", ylim=c(.12, .46))
abline(h=median.r2.2015, lty=2, col="blue")


hist(median.r2, main="Median R2 Per Model", xlab="Median R2", xlim=c(.12, .46))
points(median.r2.2015, 0, pch=16,  col= "blue", cex=2)
text(median.r2.2015)


##add 2015 model
mod.2015=read.csv("C:/Users/ksanf/Documents/SD/2015_tests/2015_LOOCV_reconstruction_WET.csv")
...
plot(median.rmse, main = "Median RMSE Values", ylab="Median RMSE", ylim=c(239,317))
abline(h=median.rmse.2015, lty=2, col="blue")


hist(median.rmse, main="Median RMSE Per Model", xlab="Median RMSE", xlim=c(239, 317))
...
plot(median.re, main = "Median RE Values", ylab="Median RE", ylim=c(.018, .44))
abline(h=median.re.2015, lty=2, col= "blue")


hist(median.re, main="Median RE Per Model", xlab="Median RE", xlim=c(.018, .44))

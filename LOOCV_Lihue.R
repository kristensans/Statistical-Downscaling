### plot actual with range of estimates for a single station #Lihue
rm(list=ls())
...
mod.2015=mod.2015[,"1020.1"]

boxplot(df,  names=time, las=2, cex.axis=.7, main= "LIHUE") 
